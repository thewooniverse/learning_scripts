...
- /set_model - allows user to use different chat models, accepted are [gpt-4, gpt-3.5, gpt-3, gpt-4-0613]

- /set_temp - allows user to change the temperature (0-1).

- /add_system_message - adds additional System Messages to the agent, for example "You are an expert chef or travel guide" to further personalize the model.
